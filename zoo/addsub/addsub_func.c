...
static inline int32_t sub_func(int32_t a, int32_t b, cx_idx_t sys_sel)
{
    return a - b;
}

static inline int32_t add_1000(int32_t a, int32_t b, cx_idx_t sys_sel)
{
    return a + b + 1000;
}

int32_t (*cx_func_addsub[]) (int32_t, int32_t, cx_idx_t) = {
    add_func,
    sub_func,
    add_1000
};
